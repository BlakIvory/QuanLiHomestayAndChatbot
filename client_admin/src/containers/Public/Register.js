    ...
    <div className=' flex items-center justify-center'>
      <div className='mt-3 bg-white w-[600px] p-[30px] rounded-md shadow-md pb-[100px]'>
        ...
        <div className='w-full flex flex-col gap-3 mb-4 mt-3'>
          <InputForm setInvalidatefield={setInvalidatefield} invalidatefield={invalidatefield} placeholder="Tên tài khoản ..." label={'Tên Tài Khoản : '} value={payload.name} setValue={setPayload} type={'name'} typeinput={'text'} />
          ...
          <InputForm setInvalidatefield={setInvalidatefield} invalidatefield={invalidatefield} placeholder="Email ..." label={'Email : '} value={payload.email} setValue={setPayload} type={'email'} typeinput={'email'} />
          <InputForm setInvalidatefield={setInvalidatefield} invalidatefield={invalidatefield} placeholder="Địa chỉ ..." label={'Địa chỉ : '} value={payload.address} setValue={setPayload} type={'address'} typeinput={'text'} />
        ...
        <div className=' m-2 '>Bạn đã có tài khoản ?
